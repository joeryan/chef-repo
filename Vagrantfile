...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "kiowajoe-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jttech"
  #   chef.validation_client_name = "jttech-validator"
  #   chef.validation_key_path = ".chef/jttech-validator.pem"
  # end
end
